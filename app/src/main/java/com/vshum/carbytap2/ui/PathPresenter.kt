...
import com.vshum.carbytap2.data.AnimationData
...
class PathPresenter {
    ...
    fun resetCarPosition(view: View) {
        ...
        pathView?.setCarPosition(leftPosition, topPosition)
    }
    ...
    private fun generatePoints() {
        ...
        pathView?.printRoute(points, carWidth, carHeight)
    }
